	...
	methods: {
		...
		init(res = {}) {
			if (Object.keys(res).length > 0) {
				console.log(res)
				this.provinceData = res.data.provinceData;
		...
		_getCityName() {
			// return this.areaDataList[this.pickerValue[2]].value;
			var tempList = [];
			tempList[0] = this.provinceDataList[this.pickerValue[0]].label;
			tempList[1] = this.cityDataList[this.pickerValue[1]].label;
			tempList[2] = this.areaDataList[this.pickerValue[2]].label;
			return tempList;
		}
	},
	async created() {
