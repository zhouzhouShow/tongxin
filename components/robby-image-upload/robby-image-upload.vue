	...
	<view class="imageUploadContainer">
		<view class="imageUploadList">
			...
			<view v-if="isShowAdd" class="imageUpload" @tap="selectImage">
				<view><image src="../../static/icon/uploadImg.png" mode=""></image></view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		props: ['value','enableDel','enableAdd','enableDrag','serverUrl','formData','limit','fileKeyName','showUploadProgress','serverUrlDeleteImage','disabled'],
		data() {
			return {
				imageBasePos:{
					x0: -1,
