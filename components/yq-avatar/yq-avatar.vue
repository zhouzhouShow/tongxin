		...
		<view class="oper-wrapper" :style="{display: styleDisplay}">
			<view class="oper">
				<view class="btn-wrapper" v-if="showOper">
					<view @click="fSelect"  hover-class="hover" v-if="chongxuan" :style="{width: btnWidth}"><text>重选</text></view>
					<view @click="fClose"  hover-class="hover" v-if="guanbi" :style="{width: btnWidth}"><text>取消</text></view>
					<view @click="fRotate"  hover-class="hover" v-if="xuanzhuan" :style="{width: btnWidth, display: btnDsp}"><text>旋转</text></view>
					<view @click="fPreview" hover-class="hover" v-if="yulan" :style="{width: btnWidth}"><text>预览</text></view>
					<view @click="fUpload"  hover-class="hover" v-if="shangchuan" :style="{width: btnWidth}"><text>完成</text></view>
				</view>
